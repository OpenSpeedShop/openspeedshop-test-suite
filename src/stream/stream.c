...
#pragma omp master
	    ...
	    k2 = omp_get_max_threads();
	    k3 = omp_get_num_procs();
            printf ("Number of Threads requested = %i\n",k);
            printf ("get_max_threads             = %i\n",k2);
            printf ("get_num_procs               = %i\n",k3);
        }
    }
#endif
...
#pragma omp parallel for
    ...
    checkSTREAMresults();
    printf(HLINE);
    //std::cout << "Total walltime triad " << walltime << "\n";
    printf ("Total triad walltime %f \n", walltime);
