...
message(STATUS "OpenMPI Finding: OpenMPI_CXX_LIBRARY_SHARED: " ${OpenMPI_CXX_LIBRARY_SHARED})
...
message(STATUS "OpenMPI Finding: OpenMPI_MPIFH_LIBRARY_SHARED: " ${OpenMPI_MPIFH_LIBRARY_SHARED})
...
if (OpenMPI_CXX_LIBRARY_SHARED)
    message(STATUS "OpenMPI ADDING: OpenMPI_CXX_LIBRARY_SHARED: " ${OpenMPI_CXX_LIBRARY_SHARED})
    set(OpenMPI_SHARED_LIBRARIES ${OpenMPI_SHARED_LIBRARIES} ${OpenMPI_CXX_LIBRARY_SHARED})
endif()

if (OpenMPI_MPIFH_LIBRARY_SHARED)
    message(STATUS "OpenMPI ADDING: OpenMPI_MPIFH_LIBRARY_SHARED: " ${OpenMPI_MPIFH_LIBRARY_SHARED})
    set(OpenMPI_SHARED_LIBRARIES ${OpenMPI_SHARED_LIBRARIES} ${OpenMPI_MPIFH_LIBRARY_SHARED})
endif()
